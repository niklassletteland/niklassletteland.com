...
<?php include('../../includes/middle.php'); ?>
	...
	<div class="breadcrumbs">
		<a href="<?php echo($home); ?>portfolio/">portfolio</a> &mdash;> <a href="">school of athens colorization</a>
	</div>
	...
	<div class="img-box" style="max-width:664px;">
		<img src="../../img/portfolio/athens-demo.jpg" alt="the 'school of athens' image colorization in action" />
	...
	<section>
		...
		<div class="img-box" style="max-width:700px;">
			<img src="../../img/portfolio/diogenes.jpg" alt="the lightbox that is initialized by clicking a character" />
	...
	<div class="img-box" style="max-width:666px;">
		<img src="../../img/portfolio/athens-colorization-multi.jpg" alt="moving one's mouse quickly allows many zones to become colorized at once" />

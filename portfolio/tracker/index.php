...
<?php include('../../includes/middle.php'); ?>
	...
	<div class="breadcrumbs">
		<a href="<?php echo($home); ?>portfolio/">portfolio</a> &mdash;> <a href="">tracker</a>
	</div>
	...
	<div class="img-box" style="max-width:1000px;">
		<img src="../../img/portfolio/tracker-1.jpg" alt="Timing a project using the Tracker" />
	...
	<div class="img-box" style="max-width:906px;">
		<img src="../../img/portfolio/tracker-5.jpg" alt="demonstration of the tracker responding to screen size" />
		<p class="caption">the tracker is fully responsive. the custom tab interface is used to navigate between UI elements</p>
	</div>
	
	<div class="img-box" style="max-width:1000px;">
		<img src="../../img/portfolio/tracker-2.jpg" alt="viewing past projects with the tracker" />

...
<?php include('../../includes/middle.php'); ?>
	...
	<div class="breadcrumbs">
		<a href="<?php echo($home); ?>portfolio/">portfolio</a> &mdash;> <a href="">poets and peasants</a>
	</div>
	...
	<div class="img-box" style="max-width:1500px;">
		<img src="../../img/portfolio/poets_compare.jpg" alt="Poets and Peasants music page side by side with about page" />
	...
	<section>
		...
		<div class="img-box" style="max-width:700px;">
			<img src="../../img/portfolio/poets_splash.jpg" alt="Poets and Peasants splash page" />

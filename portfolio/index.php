...
<div class="project_box" style="background-image:url('../img/portfolio/tracker_thumb.jpg');">
	<a href="tracker/">
		<div class="mask"></div>
...
<div class="project_box mult_two" style="background-image:url('../img/portfolio/athens_thumb.jpg');">
...
<div class="project_box mult_three" style="background-image:url('../img/portfolio/cmap_thumb.jpg');">
	<a href="cmap/">
		<div class="mask"></div>
		<div class="description">
...
<div class="project_box mult_two" style="background-image:url('../img/portfolio/colorize_thumb.jpg');">
	<a href="colorize/">
		<div class="mask"></div>
		<div class="description">
...
<div class="project_box" style="background-image:url('../img/portfolio/poets_thumb.jpg');">

...
<?php include('../../includes/middle.php'); ?>
	...
	<div class="breadcrumbs">
		<a href="<?php echo($home); ?>portfolio/">portfolio</a> &mdash;> <a href="">colorize</a>
	</div>
	...
	<div class="img-box" style="max-width:649px;">
		<img src="../../img/portfolio/colorize-examples.jpg" alt="consummatumest.com homepage" />
	...
	<div class="img-box" style="max-width:662px;">
		<img src="../../img/portfolio/sheppard.jpg" alt="the sheppard region of the image being colorized" />

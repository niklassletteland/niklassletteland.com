...
<?php include('../../includes/middle.php'); ?>
	...
	<div class="breadcrumbs">
		<a href="<?php echo($home); ?>portfolio/">portfolio</a> &mdash;> <a href="">cMap</a>
	</div>
	...
	<div class="img-box" style="max-width:650px">
		<img src="../../img/portfolio/cmap.jpg" alt="an image of the cMap in action" />
	...
	<div class="img-box" style="max-width:1369px">
		<img src="../../img/portfolio/cmap-overview.jpg" alt="an zoomed out image of the cMap, showing the whole campus" />
	...
	<section>
		...
		<div class="img-box" style="max-width:969px">
			<img src="../../img/portfolio/generator-example.jpg" alt="an example of the custom link generator" />
